        ...
        <div class="card">
          <div class="card-body p-5">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="file" name="image" class="form-control" id="image" <?php if(!isset($banner)){ echo "required"; } ?> onchange="previewFile(this);">
                <img id="previewImg" src="<?php if(isset($banner)){ echo url("public/images/".$data->image);}else{ ?>../public/img/image-preview.png<?php } ?>" alt="Placeholder" width="100px">                
              </div>
            </div>
            <div class="row mb-3">
              <label for="name" class="col-sm-2 col-form-label">Heading</label>
              <div class="col-sm-10">
                <input type="text" name="name" class="form-control" placeholder="Heading" id="name" value="<?php if(isset($banner)){ echo $banner->name; } ?>">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <textarea class="form-control" name="discription"><?php if(isset($banner)){ echo $banner->discription; } ?></textarea>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-10">
                <input type="hidden" name="banner_id" id="banner_id" value="<?php if(isset($banner)){ echo $banner->id; } ?>">
