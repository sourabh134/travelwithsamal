      ...
      <div class="col-12">
        <div class="page_title_box d-flex align-items-center justify-content-between">
          <div class="page_title_left">
            <h4 class="f_s_30 f_w_700 text_white"><?php if(isset($banner)){ echo "Update"; }else{ echo "Add"; } ?> Destination</h4>
            <ol class="breadcrumb page_bradcam mb-0">
              <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></li>
              <li class="breadcrumb-item"><a href="{{ url('admin/destinationimage') }}">Destination</a></li>
              <li class="breadcrumb-item active"><?php if(isset($banner)){ echo "Update"; }else{ echo "Add"; } ?> Destination</li>
            </ol>
          </div>
        ...
        <div class="card">
          <div class="card-body p-5">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="file" name="image" class="form-control" id="image" <?php if(!isset($data)){ echo "required"; } ?> onchange="previewFile(this);">
                <img id="previewImg" src="<?php if(isset($data)){ echo url("public/img/destination/".$data->image);}else{ ?>../public/img/image-preview.png<?php } ?>" alt="Placeholder" width="100px">                
              </div>
            </div>
            <div class="row mb-3">
              <label for="name" class="col-sm-2 col-form-label">Name</label>
              <div class="col-sm-10">
                <input type="text" name="name" class="form-control" placeholder="Name" id="name" value="<?php if(isset($data)){ echo $data->name; } ?>">
...
<script>
  function get_form_data(){
    ...
    $.ajax({  
      type:"POST",
      url:"{{url('admin/insertdestinationimage')}}",
      ...
      success:function(data)
      {
        ...
        { 
          ...
          $('#end_date_error').html('');
          setTimeout(() => {
            window.location.href = "<?php echo url('admin/destinationimage'); ?>";
          }, 5000);
        }
