                ...
                <tr>
                    ...
                    <td valign="top">
                        ...
                        <div style="max-width: 600px; margin: 0 auto; padding: 0 12px;text-align:center;">
                            ...
                            <div class="card" style="background: white; border-radius: 0.5rem; padding: 2rem;">

                              <a href="{{url('/')}}">

                              <img src="{{asset('public/assets/img/logo-web.png')}}" style="width: 85px; margin: 0 215px 12px 215px;"></a>

                                <h2 style="color: #9dda32; margin: 0 0 12px; line-height: 30px;">Your OTP here...</h2>

                                

                               <!--  <p style="margin-bottom: 1rem;">Your Account details.</p> -->
                        ...
                        <div style="max-width: 600px; margin: 0 auto;">
                            ...
                            <p class="footer_address" style="margin-top: 16px; font-size: 12px; line-height: 20px;">
                              ...
                              <br>
                                ...
                                <a href="{{url('/')}}" style="font-weight: bold; color: #9dda32;font-size: 16px;text-decoration: none;">OMCA TEAM</a>
